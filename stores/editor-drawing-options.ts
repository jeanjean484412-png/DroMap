...
type EditorDrawingOptionsState = {
...
export const useEditorDrawingOptionsStore =
  create<EditorDrawingOptionsState>((set) => ({
    markerStyle: {
      color: "#000000",
      opacity: 1,
      markerSize: 22,
...
export function applyDrawingPresetToFeature(
  ...
  const state = useEditorDrawingOptionsStore.getState();
