...
export function SelectedFeatureActions() {
  ...
  const updateFeatureWithHistory = useEditorFeaturesStore(
  ...
  const requestOpenFeatureInObjectsPanel = useEditorSelectionStore(
    ...
    return (
      ...
      >
        <div
          ...
          className="pointer-events-auto flex max-w-[calc(100vw-2rem)] origin-center scale-[0.9] items-center gap-2 overflow-x-auto rounded-2xl border-2 border-teal-300 bg-white p-2 shadow-[0_16px_45px_rgba(15,23,42,0.32)] ring-1 ring-black/5 xl:max-w-[calc(100vw-36rem)]"
        >
          <div className="rounded-xl border border-teal-200 bg-teal-50 px-3 py-2">
            <div className="text-[9px] font-bold uppercase tracking-[0.14em] text-teal-600">
              Sélection multiple
            </div>
          ...
          <button
            ...
            className="flex h-10 items-center justify-center whitespace-nowrap rounded-xl border border-teal-700 bg-teal-600 px-4 text-[11px] font-extrabold text-white shadow-sm transition hover:bg-teal-700"
          >
            Modifier ensemble
          </button>
          <button
  ...
  return (
    ...
    >
      <div
        ref={actionBarRef}
        data-dromap-action-bar="true"
        className="pointer-events-auto flex max-w-[calc(100vw-2rem)] origin-center scale-[0.9] flex-nowrap items-center gap-1 overflow-x-auto rounded-2xl border-2 border-slate-300 bg-white p-1.5 shadow-[0_16px_45px_rgba(15,23,42,0.32)] ring-1 ring-black/5 xl:max-w-[calc(100vw-36rem)]"
      >
        ...
        <button
          type="button"
          onClick={() => requestOpenFeatureInObjectsPanel(selectedFeatureId)}
          className="flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl border border-teal-300 bg-teal-50 px-3 text-[11px] font-extrabold text-teal-800 shadow-sm transition hover:bg-teal-100"
        >
          Modifier
        </button>
