...
import { setFeatureLayerId } from "@/stores/editor-layers";
import type {
...
function getDromapSource(dromap: Record<string, unknown>): DroMapFeatureProperties["source"] {
  ...
  return {
    ...
    sourceLabel:
      typeof source.sourceLabel === "string" ? source.sourceLabel : undefined,
    sourceUrl:
      typeof source.sourceUrl === "string" ? source.sourceUrl : undefined,
    sourceLicense:
      typeof source.sourceLicense === "string" ? source.sourceLicense : undefined,
    sourceAttribution:
      typeof source.sourceAttribution === "string"
        ? source.sourceAttribution
        : undefined,
    sourceVersion:
      typeof source.sourceVersion === "string" ? source.sourceVersion : undefined,
...
function createGeoJsonFeatureSource(input: {
  ...
  return {
    ...
    ...(input.layer.sourceLabel ? { sourceLabel: input.layer.sourceLabel } : {}),
    ...(input.layer.sourceUrl ? { sourceUrl: input.layer.sourceUrl } : {}),
    ...(input.layer.sourceLicense ? { sourceLicense: input.layer.sourceLicense } : {}),
    ...(input.layer.sourceAttribution
      ? { sourceAttribution: input.layer.sourceAttribution }
      : {}),
    ...(input.layer.sourceVersion ? { sourceVersion: input.layer.sourceVersion } : {}),
