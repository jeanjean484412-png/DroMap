import { DROMAP_CSS_FONT_FAMILY, getDromapRuntimeFontFamily } from "@/lib/dromap/font-family";
...
export function measureExportTextWidth(
  ...
  context.font = `${fontWeight} ${safeFontSize}px ${getDromapRuntimeFontFamily()}`;
