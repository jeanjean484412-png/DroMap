  ...
  return (
    <>
      <button
        ...
        className={[
          "group relative inline-flex h-9 w-11 shrink-0 items-center justify-center rounded-xl border border-slate-300 bg-white p-1 shadow-sm transition hover:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-200 disabled:cursor-not-allowed disabled:opacity-50",
          className,
        ].join(" ")}
      >
        <span
      ...
      {open && typeof document !== "undefined"
        ? createPortal(
            <div
              ...
              className="fixed z-[10000] max-h-[calc(100vh-1rem)] w-[300px] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-3 text-slate-800 shadow-lg ring-1 ring-black/5"
            ...
            >
              ...
              <label className="mt-3 block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 font-mono text-sm uppercase text-slate-900 outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-100"
                />
              </label>

              {recentColors.length > 0 ? (
                <div className="mt-3 rounded-xl border border-teal-100 bg-teal-50/70 p-2.5">
                  <div className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-teal-700">
                    Couleurs récentes
                  </div>
                  <div className="grid grid-cols-8 gap-2">
                    {recentColors.map((recentColor) => (
                      <button
                        ...
                        className={[
                          "h-7 w-7 rounded-lg border shadow-sm transition focus:outline-none focus:ring-2 focus:ring-teal-300",
                ...
                <div className="grid grid-cols-10 gap-1.5">
                  {PRESET_COLORS.map((preset) => (
                    <button
                      ...
                      className={[
                        "h-5 w-5 rounded-md border shadow-sm transition focus:outline-none focus:ring-2 focus:ring-teal-300",
              ...
              <div className="mt-4 grid grid-cols-2 gap-2 border-t border-slate-100 pt-3">
                ...
                <button
                  ...
                  className="rounded-xl border border-teal-700 bg-teal-600 px-3 py-2 text-xs font-extrabold text-white shadow-sm transition hover:bg-teal-700"
                >
