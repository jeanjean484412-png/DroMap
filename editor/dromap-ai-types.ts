...
export type DroMapAiMapPosition = {
  x: number;
  y: number;
};

export type DroMapAiConversationTurn = {
  role: "user" | "assistant";
  text: string;
};

export type DroMapAiPrePlanQuestionOption = {
  id: string;
  label: string;
};

export type DroMapAiPrePlanQuestion = {
  id: string;
  label: string;
  multiple: boolean;
  options: DroMapAiPrePlanQuestionOption[];
};
...
export type DroMapAiCommand = {
  ...
  roadCategories: DromapRoadImportCategory[];
  roadSelectionMode: "all" | "named" | null;
  roadQueries: string[];
  ...
  legendMapPosition: DroMapAiMapPosition | null;
  legendMapTitlePosition: DroMapAiMapPosition | null;
  ...
  legendLabelLineHeight: number | null;
  ...
  mapTitlePosition: DroMapAiMapPosition | null;
  mapTitleFontSize: number | null;
  mapTitleColor: string | null;
  showBasemapLabels: boolean | null;
  basemapDetailDelta: number | null;
  section: string | null;
  ...
  scaleMapPosition: DroMapAiMapPosition | null;
  northStyle: ExportNorthArrowStyle | null;
  northPosition: ExportMapElementPosition | null;
  northMapPosition: DroMapAiMapPosition | null;
...
export type DroMapAiBuildingContinuation = {
...
export type DroMapAiRouteContinuation = {
  originalPrompt: string;
  selections: Array<{
    commandId: string;
    selectedCount: number;
...
export type DroMapAiApiRequest = {
  ...
  conversation?: DroMapAiConversationTurn[];
  stepRevision?: DroMapAiStepRevisionRequest;
  buildingContinuation?: DroMapAiBuildingContinuation;
  routeContinuation?: DroMapAiRouteContinuation;
};

export type DroMapAiApiResponse = {
  plan: DroMapAiPlan | null;
  assistantMessage: string;
  questions: DroMapAiPrePlanQuestion[];
  model: string;
  grounded: boolean;
