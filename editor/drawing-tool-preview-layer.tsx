...
const PLACEMENT_TOOLS = new Set<EditorActiveTool>([
  "marker",
  "line",
  "freehand",
  "trace-line",
...
const GEOMETRY_PREVIEW_TOOLS = new Set<EditorActiveTool>([
  "line",
  "zone",
  "shape",
]);
...
function getCursorPreviewTransform(activeTool: EditorActiveTool) {
