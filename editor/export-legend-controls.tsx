  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3">
      ...
      <button
        ...
        className="mb-3 w-full rounded-lg border border-teal-200 bg-teal-50 px-3 py-2 text-xs font-medium text-teal-800 hover:bg-teal-100"
      >
                      ...
                      <div
                        ...
                        className={[
                          ...
                          draggedGroupKey === entry.dedupeKey
                            ? "border-teal-300 bg-teal-50 opacity-70"
                            : isHidden
                        ...
                        <div className="mb-2 grid gap-1">
                          <label className="grid gap-1 text-[10px] font-medium uppercase tracking-wide text-slate-500">
                            ...
                            <input
                              ...
                              className="w-full rounded-md border border-slate-200 bg-white px-2 py-1.5 text-xs font-medium normal-case tracking-normal text-slate-900 outline-none focus:border-teal-300 focus:ring-2 focus:ring-teal-100"
