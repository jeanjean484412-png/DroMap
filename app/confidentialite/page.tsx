    ...
    >
      ...
      <LegalSection id="prestataires" title="4. Prestataires et destinataires">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li><strong>OpenAI — API :</strong> traitement des demandes adressées à l’Assistant IA, recherche web lorsque la demande le nécessite et production des réponses. DroMap désactive la conservation de l’état des réponses par l’API avec <code>store: false</code>. Les durées applicables aux autres journaux techniques dépendent des conditions du prestataire.</li>
